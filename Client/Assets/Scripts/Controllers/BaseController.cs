...
public class BaseController : MonoBehaviour
{
    ...
    // hp, maxhp는 위쪽에 올리는것이 좋긴한데. speed는 화살도 공통적으로 사용하고 있다
    ...
    protected virtual void Init()
    {
        ...
        // Objectmanger의 Add부분에서 먼저 packet 정보를 받고 있고 그 다음에 여기 Init에서 덮어쓴다.
        // 객체가 생성이 된 이후에 실행되는 것이므로 강제로 밀어넣으면 안된다.
        // 내가 죽은 다음에 respawn되었을 때 monster 엉뚱한 방향을 바라보는 문제 해결
